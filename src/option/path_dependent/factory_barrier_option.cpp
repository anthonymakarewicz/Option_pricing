...
namespace OptionPricer {
    ...
    std::unique_ptr<PayoffSingleStrike> KnockInBarrierOptionFactory::createSpecificPayoff(const ParameterObject &params,
    ...
    std::unique_ptr<PayoffSingleStrike> KnockOutBarrierOptionFactory::createSpecificPayoff(const ParameterObject &params,
                                                                               const PayoffType& type) {
        return std::make_unique<PayoffVanilla>(type, params.getParameter<double>("K"));
    }
