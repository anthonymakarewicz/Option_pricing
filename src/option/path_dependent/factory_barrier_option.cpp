...
namespace OptionPricer {
    ...
    std::shared_ptr<KnockInBarrierOption> KnockInBarrierOptionFactory::createSpecificOption(const ParameterObject &params,
    ...
    std::shared_ptr<KnockOutBarrierOption> KnockOutBarrierOptionFactory::createSpecificOption(const ParameterObject &params,
    std::unique_ptr<Payoff> payoff, const std::shared_ptr<IMarketData>& marketData) {
